...
<body>
    ...
    <table id="check">
    	...
    	<c:forEach var="i" items='${orderedList }'>
...
<!-- 	<form action="searchAdminOrder.sp" method="post">
    ...
    <div id="navOrder">
        <ul class="uk-breadcrumb">
                <li><a href="${pageContext.request.contextPath}/orderAdminList.sp">전체</a></li>
                <li><a href="${pageContext.request.contextPath}/orderedList.sp">주문</a></li>
                <li><a href="${pageContext.request.contextPath}/orderAdminList.sp">환불</a></li>
                <li><a href="${pageContext.request.contextPath}/orderAdminList.sp">취소</a></li>
                <li><a href="${pageContext.request.contextPath}/orderAdminList.sp">상품 준비</a></li>
                <li><a href="${pageContext.request.contextPath}/orderAdminList.sp">배송 준비</a></li>
                <li><a href="${pageContext.request.contextPath}/orderAdminList.sp">배송 중</a></li>
                <li><a href="${pageContext.request.contextPath}/orderAdminList.sp">배송 완료</a></li>
                <li><a href="${pageContext.request.contextPath}/orderAdminList.sp">개별 주문</a></li>
                <li><span></span></li>
        </ul>
    </div>
	                ...
	                <td>
	                    <!-- ajax -->
	                        ...
	                        <select id="newStatus" name="newStatus">
	                            <option id="ordered" value="주문접수" <c:if test="${i.orderStatusName == '주문'}">selected</c:if>>주문접수</option>
	                            <option id="refund" value="환불" <c:if test="${i.orderStatusName == '환불'}">selected</c:if>>환불</option>
	                            <option id="cancel" value="주문취소" <c:if test="${i.orderStatusName == '취소'}">selected</c:if>>주문취소</option>
