...
public class OrderDetail extends Order{
	...
	public OrderDetail(int orderNo, Date orderDate, int totalPrice, String orderRequest, String emailId,
			String orderStatusName, String recipientName, String recipientAdr, String recipientPhone, int orderDetailNo,
			int orderAmount, int productNo) {
	...
	public String toString() {
		return "OrderDetail [orderDetailNo=" + orderDetailNo + ", orderAmount=" + orderAmount + ", productNo="
				...
				+ ", getTotalPrice()=" + getTotalPrice() + ", getOrderRequest()=" + getOrderRequest()
				+ ", getEmailId()=" + getEmailId() + ", getOrderStatusName()=" + getOrderStatusName()
